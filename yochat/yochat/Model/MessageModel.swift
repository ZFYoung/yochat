...
class MessageModel: NSObject,NSCoding {
    ...
    init(dic:NSDictionary) {
        self.fromId = MessageModel.STRTOINT(str: dic.value(forKey: "FROMID") as! String);
        self.toId = MessageModel.STRTOINT(str: dic.value(forKey: "TOID") as! String);
        self.content = dic.value(forKey: "CONTENT") as! String;
        self.imageUrl = dic.value(forKey: "IMAGEURL") as! String;
        self.msgType = MessageType(rawValue: MessageModel.STRTOINT(str: dic.value(forKey: "MESSAGETYPE") as! String));
        self.time = MessageModel.STRTOINT(str: dic.value(forKey: "TIME") as! String);
    }
    
    func transToDic() -> NSDictionary {
        let retDic = NSMutableDictionary.init();
        
        retDic.setObject(MessageModel.INTTOSTR(iit: self.fromId), forKey: "FROMID" as NSCopying);
        retDic.setObject(MessageModel.INTTOSTR(iit: self.toId), forKey: "TOID" as NSCopying);
        retDic.setObject(self.content, forKey: "CONTENT" as NSCopying);
        retDic.setObject(self.imageUrl, forKey: "IMAGEURL" as NSCopying);
        retDic.setObject(MessageModel.INTTOSTR(iit: self.msgType.rawValue), forKey: "MESSAGETYPE" as NSCopying);
        retDic.setObject(MessageModel.INTTOSTR(iit: self.time), forKey: "TIME" as NSCopying);
